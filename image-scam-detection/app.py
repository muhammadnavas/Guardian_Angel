...
from agents import GuardianAngelTeam
from tools.formatter import AutoGenFormatter


title = "Guardian Angel: LLM Agents for Scam Protection"
description = """
              🦉 Guardian Angel uses LLM Agents to analyze screenshots for potential scams. </br>
...
with gr.Blocks() as demo:
    with gr.Tab("Guardian Angel: AI Guardian for Scam Protection"):
        with gr.Row():
            gr.Interface(
                fn=predict,
                inputs=inputs,
