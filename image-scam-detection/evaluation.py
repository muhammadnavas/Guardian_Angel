...
class GuardianAngelEvaluator:
    def __init__(self):
        self.agents = GuardianAngelTeam()
        self.db_connector = DatabaseConnector()
   
        self.logger = logging.getLogger(__name__ + '.GuardianAngelEvaluator')
...
async def main():
    evaluator = GuardianAngelEvaluator()
